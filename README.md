...
Quick Start
Install and start Apache through XAMPP.
Install SQL Server and make it reachable at localhost,15432, or override the host and port through environment variables.
Enable the PHP sqlsrv extension.
Import or apply the SQL scripts from Database/ in the expected order for your environment.
Configure environment variables based on .env.example.
Open the application at the configured AIS_SITE_URL.
