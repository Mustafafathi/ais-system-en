            ...
            <div class="card-body">
                <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px">
                    ...
                    <div>
                        ...
                        <div style="color:var(--c-muted);font-size:13px">Куратор</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Группа</label>
                    <div id="prof-group" class="form-static">—</div>
                </div>
                <div class="form-group">
...
(function () {
    ...
    async function loadProfile() {
        try {
            ...
            var curatorId = pick(s,'Куратор_ID','curator_id') || 0;
            ...
            var ini = fio.split(' ').map(function(p){return p?p[0].toUpperCase():''}).join('').slice(0,2) || 'К';
            document.getElementById('prof-avatar').textContent = ini;
            document.getElementById('prof-name').textContent   = fio;
            document.getElementById('prof-group').textContent  = group;
